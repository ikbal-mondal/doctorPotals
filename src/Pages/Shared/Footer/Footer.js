...
const Footer = () => {
    return (
        <div  className='mt-16'>
            <footer 
			 ...
			 className="px-4 divide-y border-t-2 ">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-50">ORAL HEALTH</h3>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				<h3 className="uppercase dark:text-gray-50">OUR ADDRESS</h3>
				<ul className="space-y-1">
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© Copyright 2022 All Rights Reserved</div>
</footer>
        </div>
    );
};
